...
import MaterialUsage from './pages/supervisor/MaterialUsage';
  ...
  return (
    <Routes>
      ...
      <Route element={
        ...
        <Route path="/admin/material-requests" element={
          <ProtectedRoute allowedRoles={['admin']}>
            <AdminMaterialRequests />
          </ProtectedRoute>
        } />
        ...
        <Route path="/supervisor/materials" element={
          <ProtectedRoute allowedRoles={['supervisor']}>
            <MaterialUsage />
          </ProtectedRoute>
        } />
