...
const Sidebar = () => {
  ...
  const links = {
    ...
    admin: [
      ...
      { path: '/admin/worker-requests', label: 'Worker Requests', icon: <PlusCircle size={18} /> },
      { path: '/admin/workers', label: 'Manage Workers', icon: <Users size={18} /> },
      { path: '/admin/users', label: 'System Users', icon: <ClipboardList size={18} /> },
      { path: '/notifications', label: 'Notifications', icon: <Bell size={18} /> },
    ],
    supervisor: [
      { path: '/supervisor/dashboard', label: 'My Department', icon: <Briefcase size={18} /> },
      { path: '/supervisor/inventory', label: 'Inventory', icon: <Package size={18} /> },
      { path: '/supervisor/request-material', label: 'Request Stock', icon: <PlusCircle size={18} /> },
      { path: '/notifications', label: 'Notifications', icon: <Bell size={18} /> },
    ],
  };
